...
this project. Study this project's tech stack, build/test/lint commands,
...
| [Recommended Tools](./guide/recommended-tools.md) | Curated tools for engineers, designers, and PMs (Claude Code, Cursor, Codex) |
